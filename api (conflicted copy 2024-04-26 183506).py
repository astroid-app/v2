...
@api.get(
    "/",
    description="Does nothing. Just sitting there and waiting for requests. (Redirects on 'GET' to the "
    "documentation.)",
)
def root():
                ...
                if f"{endpoint}.json" in os.listdir(
                    ...
                    if webhook_discord:
                        if (
                            ...
                            json_file["config"]["webhooks"]["discord"][
                                index
                            ] = webhook_discord
                        else:
                    ...
                    if webhook_guilded:
                        if (
                            ...
                            json_file["config"]["webhooks"]["guilded"][
                                index
                            ] = webhook_guilded
                        else:
                    ...
                    if webhook_revolt:
                        if webhook_revolt in json_file["config"]["webhooks"]["revolt"]:
                            ...
                            json_file["config"]["webhooks"]["revolt"][
                                index
                            ] = webhook_revolt
                        else:
                    ...
                    if channel_discord:
                        if (
                            ...
                            json_file["config"]["channels"]["discord"][
                                index
                            ] = channel_discord
                        else:
                    ...
                    if channel_guilded:
                        if (
                            ...
                            json_file["config"]["channels"]["guilded"][
                                index
                            ] = channel_guilded
                        else:
                    ...
                    if channel_revolt:
                        if channel_revolt in json_file["config"]["channels"]["revolt"]:
                            ...
                            json_file["config"]["channels"]["revolt"][
                                index
                            ] = channel_revolt
                        else:
                    ...
                    if message_embed:
                        if (
                            not "http" in message_content
                            and not "https" in message_content
                        ):
                            ...
                            if not updated_json["config"]["channels"]["discord"]:
                                ...
                                if message_content:
                                    await nextcord.Webhook.from_url(
                                        ...
                                        content=updated_json["meta"]["message"][
                                            "content"
                                        ],
                                        avatar_url=updated_json["meta"]["message"][
                                            "author"
                                        ]["avatar"],
                                        username=updated_json["meta"]["message"][
                                            "author"
                                        ]["name"],
                                    )
